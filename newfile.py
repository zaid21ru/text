...
try:
	...
	kaayy = requests.get('https://raw.githubusercontent.com/zaid21ru/text/refs/heads/main/keyee').text
	ex=int(kaayy)
	ded = dod.splitlines()
except:
	try:
...
def chzm(email):
 ...
 # "account_param":user,
  ...
  "use_store_region_cookie": "1"
	...
	headers = {
    'X-Tt-Token': '03a9028f55afe20648a7a23b36801d77ef027e13fd3922ffb20a8c12a85f1358e420ea875c219603f4ade0d9748f9e0e9539698671473e6bbd514be99cbc657d9698d1e23c30b36232fd0c72c8396999fcee5cfc6b5f24ed42cb7c132d5aba8b9af24-CkA4NzgwNGI5OTM5MjY3ZmFmMjJiYzhlMDM5MGM4MTIwOWU4Y2Q2NjUzODdhYmNkMDNjNWMyYWFjNTE1ZjJlY2E4-2.0.0',
    'sdk-version': '1',
    'x-ss-dp': '1233',
